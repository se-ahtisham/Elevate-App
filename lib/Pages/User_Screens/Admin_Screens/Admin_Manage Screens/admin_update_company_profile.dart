...
class AdminUpdateCompanyProfile extends StatefulWidget {
  ...
  @override
  State<AdminUpdateCompanyProfile> createState() => _AdminUpdateCompanyProfileState();
}
            ...
            SizedBox(
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Positioned(
                    top: 120, // Center of avatar aligns with the edge (180 - 120/2 = 120)
                    left: 24,
                    child: Row(
                      ...
                      children: [
                        ...
                        // Title Text
                        const Padding(
                          padding: EdgeInsets.only(bottom: 24), // Push it slightly down to align with the lower curve of avatar
                          child: CustomText(
                            text: "Tectzeee",
                            fontSize: 26,
