...
class CompanyFindUserPortfolio extends StatefulWidget {
  const CompanyFindUserPortfolio({super.key});

  @override
  State<CompanyFindUserPortfolio> createState() =>
      _CompanyFindUserPortfolioState();
}

class _CompanyFindUserPortfolioState extends State<CompanyFindUserPortfolio> {
  int currentIndex = 0;
