...
class CompanyViewUserProfile extends StatefulWidget {
  const CompanyViewUserProfile({super.key});

  @override
  State<CompanyViewUserProfile> createState() => _CompanyViewUserProfileState();
}

class _CompanyViewUserProfileState extends State<CompanyViewUserProfile> {
